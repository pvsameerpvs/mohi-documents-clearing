              ...
              <SheetContent side="right" className="w-[280px] sm:w-[320px]">
                ...
                <div className="mt-6 space-y-3 border-t border-charcoal/10 pt-6">
                  ...
                  <Button asChild variant="outline" className="w-full h-12 rounded-xl group hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all" onClick={() => setOpen(false)}>
                    <a href="https://www.facebook.com/share/1AFuwXiUKr/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-[#1877F2] group-hover:text-white transition-colors">
